...
1.3MB RDS file with `r format(dim(dfsamp)[1], big.mark=",")` rows of data.
...
There are `r format(dim(dfsamp)[2], big.mark=",")` variables in the data set which we can see by using the <b>str</b> (structure) command.
